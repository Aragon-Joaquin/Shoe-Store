...
export function ProductsFilter({
	...
	const { queryCategories, paramsCategory, deleteCategories } = useContext(SearchParamsContext)

	return (
		<aside className="flex flex-col items-start gap-y-2 px-5 py-10 w-72 bg-mainPalette-softBrown1/50 rounded">
